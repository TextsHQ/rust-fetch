        ...
        cb.client = cb.client.use_preconfigured_tls({
            let mut config = ClientConfig::builder()
                .with_cipher_suites(&[
                    ...
                    // unsupported
                    // rustls::cipher_suite::TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA,
                    // rustls::cipher_suite::TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA,
                    ...
                    // rustls::cipher_suite::TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA,
                    // rustls::cipher_suite::TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA,
                    // rustls::cipher_suite::TLS_RSA_WITH_3DES_EDE_CBC_SHA,
                ])
                .with_kx_groups(&[
                    &rustls::kx_group::X25519,
                    &rustls::kx_group::SECP256R1,
                    &rustls::kx_group::SECP384R1,
                    // &rustls::kx_group::SECP521R1, // unsupported
                ])
